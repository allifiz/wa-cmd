...
if (src.includes('function deliveryJid(jidRaw: string): string')) {
  ...
  if (!src.includes('function linkedLidForPhoneJid(')) {
...
if (changed) {
  ...
  console.log('patched: inbound/linked LID is preferred for encrypted replies.');
} else {
